      ...
      <group ref={groupRef} scale={1.4} position={[0, 0.2, 0]}>
        ...
        <group position={[2.5, 2, 0.3]}>
          ...
          <mesh scale={0.95}>
            ...
            <meshBasicMaterial color="#E84142" transparent opacity={0.05} />
          </mesh>
          {/* Red up indicator */}
        ...
        <group position={[-2.5, 1.5, 0.3]}>
          ...
          <mesh position={[-0.3, 0, 0.07]}>
            ...
            <meshBasicMaterial color="#E84142" transparent opacity={0.6} />
          </mesh>
        </group>

        {/* YES indicator button (bottom right) */}
        ...
        {/* NO indicator button (bottom left) */}
        <group position={[-1.8, -0.8, 0.2]}>
          {/* Button shadow */}
          <mesh position={[0, -0.02, -0.02]}>
            <boxGeometry args={[0.82, 0.37, 0.05]} />
  ...
  return (
    <Float speed={1.2} rotationIntensity={0.15} floatIntensity={0.25}>
      <group ref={group} scale={0.7}>
        {/* Outer ring - Avalanche smart contract */}
        <Torus
          ref={outerRingRef}
    ...
    <Float speed={2} rotationIntensity={0.2} floatIntensity={0.2}>
      <group ref={group} scale={0.85}>
        ...
        >
          ...
          <meshBasicMaterial color="#ffb0b0" transparent opacity={0.8} />
        </instancedMesh>
        <instancedMesh
          ref={darkMesh}
        ...
        >
          <icosahedronGeometry args={[1, 1]} />
          <meshBasicMaterial color="#b82d2e" transparent opacity={0.6} />
        </instancedMesh>
      </group>
    </Float>
  );
