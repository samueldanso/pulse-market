...
function PrivyConnectButton() {
  ...
  if (authenticated && address) {
    return (
      <div className="flex items-center gap-3">
        <span className="rounded-full bg-pulse-red-300/20 px-3 py-1 text-xs font-medium text-pulse-black">
  ...
  return (
    <Button
      ...
      className="gap-2 rounded-lg bg-pulse-black px-5 py-2.5 text-xs font-semibold text-white shadow-lg shadow-black/5 transition-opacity hover:bg-black/80 disabled:opacity-70 dark:bg-pulse-red-500 dark:text-white dark:shadow-none dark:hover:bg-pulse-red-400"
    >
      {isConnecting ? (
        <>
          <svg
